...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks}{: React, Node.js, Flask, Selenium, Tensorflow, Keras} \\
     \textbf{Developer Tools}{: Git, Heroku, ASK, VS Code} \\
     \textbf{Libraries}{: Pandas, NumPy, Matplotlib, OpenCV, Sklearn, BeautifulSoup, Rich, Highlight.js, Discord.js, Bootstrap}
    }}
 \end{itemize}
